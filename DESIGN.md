...
This document is the project's architecture of record. The extraction and
pricing semantics were proven by a frozen 2026-07-18 analysis preserved in
`archive/2026-07-18-snapshot/` (CSVs, workbook, builder scripts, and the
original analysis handoff); those CSVs double as golden-master test fixtures
(§11).
