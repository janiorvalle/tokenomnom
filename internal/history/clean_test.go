...
func TestClassifyPromptKindCompleteMatchAllowlist(t *testing.T) {
	tests := []struct {
		...
		{"harness teammate sandwich with quoted envelope", teammateMessagePreamble + "<teammate-message teammate_id=\"parser\">quoted <teammate-message teammate_id=\"worker\">inner</teammate-message> delivery</teammate-message>\n \t\n" + teammateMessageTrailer, PromptKindAgentMessage},
		{"nested teammate without harness trailer", teammateMessagePreamble + "<teammate-message teammate_id=\"parser\">quoted <teammate-message teammate_id=\"worker\">inner</teammate-message> delivery</teammate-message>", PromptKindHuman},
		{"nested teammate envelope without harness", "<teammate-message teammate_id=\"parser\">quoted <teammate-message teammate_id=\"worker\">inner</teammate-message> delivery</teammate-message>", PromptKindHuman},
		...
		{"harness teammate nested with trailing prose", teammateMessagePreamble + "<teammate-message teammate_id=\"parser\">quoted <teammate-message teammate_id=\"worker\">inner</teammate-message></teammate-message>\n\n" + teammateMessageTrailer + "\nThanks", PromptKindHuman},
		{"harness teammate whitespace before envelope", teammateMessagePreamble + " \n<teammate-message teammate_id=\"parser\">done</teammate-message>\n\n" + teammateMessageTrailer, PromptKindHuman},
		{"harness sandwich uses last close before exact trailer", teammateMessagePreamble + "<teammate-message teammate_id=\"parser\">first</teammate-message>\nquoted follow-up\n<teammate-message teammate_id=\"worker\">inner</teammate-message>\n\n" + teammateMessageTrailer, PromptKindAgentMessage},
		{"human prose quoting complete sandwich", "A transcript contained:\n" + teammateMessagePreamble + "<teammate-message teammate_id=\"parser\">quoted <teammate-message teammate_id=\"worker\">inner</teammate-message></teammate-message>\n\n" + teammateMessageTrailer, PromptKindHuman},
